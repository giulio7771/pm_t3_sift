...
class matchers:
	...
	def match(self, i1, i2, direction=None):
		...
		if len(good) > 59:
			...
			H, s = cv2.findHomography(matchedPointsCurrent, matchedPointsPrev, cv2.RANSAC, 59)
			return H
		return None
...
class Stitch:
	def __init__(self, args):
		filenames = ["images/au1.jpg", "images/au3.jpg", "images/au2.jpg"]
...
if __name__ == '__main__':
	...
	s.rightshift()
	print "done"
	cv2.imwrite("resultado.jpg", s.leftImage)
	print "image written"
